...
ENTITY synth IS
	...
	PORT(
		...
		WAV_SELECT		: IN std_logic_vector(7 downto 0) --only used for tb purpose
	);
...
signal out_function_btn : std_logic_vector(7 downto 0);
...
BEGIN
	...
	MIXER_INST: entity work.mixer_entity 
		port map(
				...
				DATA_SA_2		=>SA_DATA2,
				DATA_TR_2		=>TR_DATA2,
				WAV_SELECT		=>WAV_SELECT, -- replace with out_function_btn
